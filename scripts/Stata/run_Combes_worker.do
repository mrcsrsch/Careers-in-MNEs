...
foreach dtafile in basic_worker fullwosize_worker full_worker interacted_worker {
	* Prepate data 
	** load data 
...
esttab basic_worker fullwosize_worker full_worker interacted_worker using table_Combes_workerfe.txt, r2 se label replace title(Comparison of worker fixed effects distributions, MNEs vs Domestic Companies\label{tab:Combes_company})
esttab basic_worker fullwosize_worker full_worker interacted_worker using table_Combes_workerfe.tex, r2 se replace title(Comparison of worker fixed effects distributions, MNEs vs Domestic Companies\label{tab:Combes_company})
